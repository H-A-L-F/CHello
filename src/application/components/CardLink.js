...
const CardLink = ({ card }) => {
    ...
    useEffect(() => {
        ...
        // const q = query(collection(db, "cardLink"), where("cardId", "==", cardId))
    }, []);
    ...
    return (
        <div ref={ref}>
            ...
            {open ? (
                <div className="z-30 !CLICKED_LABEL bg-white border-gray-50 border rounded drop-shadow-xl h-fit absolute w-[25rem]">
